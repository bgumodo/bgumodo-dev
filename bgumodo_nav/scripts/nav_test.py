...
class NavTest():
    def __init__(self):
        ...
        locations['room_7_door'] = Pose(Point(-2.463, 12.147, 0.000), Quaternion(0.000, 0.000, -0.555, 0.832))
        ...
        self.cmd_vel_pub = rospy.Publisher('/komodo_1/diff_driver/command', Twist)
